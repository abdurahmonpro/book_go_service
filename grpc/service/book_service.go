...
func (i *BookService) GetBookByTitle(ctx context.Context, req *book_service.BookByTitle) (*book_service.BookResponseByItem, error) {
	...
	response := &book_service.BookResponseByItem{
		Data:    []*book_service.Book{book},
		IsOk:    true,
		Message: "ok",
	}
